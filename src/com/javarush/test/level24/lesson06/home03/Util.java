    ...
    public static List<Jeans> getAllJeans() {
        ...
        abstract class AbstractJeans implements Jeans{
            ...
            public String toString() {
                String str=new String(AbstractJeans.class.getSimpleName());

                if (getTM().equals(Company.Levis.fullName)){
                    str=Company.Levis.toString();
                }else if (getTM().equals(Company.Denim.fullName)){
                    str=Company.Denim.toString();
                }else if (getTM().equals(Company.Colins.fullName)){
                    str=Company.Colins.toString();
                }else if (getTM().equals(Company.CalvinKleinJeans.fullName)){
                    str=Company.CalvinKleinJeans.toString();
                }
