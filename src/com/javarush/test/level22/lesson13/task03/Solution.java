...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(checkTelNumber("+38(0(50)1234567"));//false
        System.out.println(checkTelNumber("+38(050)123-4567"));//true
        ...
        System.out.println(checkTelNumber("(050)123-45-67"));//true
        System.out.println(checkTelNumber("050123-4567"));//true
        System.out.println(checkTelNumber("050123-45-67"));//true
        System.out.println(checkTelNumber("0501923-45-67"));//false
    }
}
