...
public class Solution extends AbstractList<String> implements List<String>,Cloneable,Serializable {
    ...
    private static class Node<E> {
        ...
        //конструктор
        Node(E item, Node<E> next, Node<E> prev, Node<E> parent, Node<E> left, Node<E> right) {
            this.item = item;
            this.next = next;
            this.prev = prev;
            this.parent = parent;
    ...
    Node<String> root=new Node("0",null,null,null,null,null);
    //return true - добавление прошло успешно
    //return false - добавление не прошло
    //@Override`
    public boolean add(String value) {
        //создаем новый узел
        Node<String> newNode=new Node(value,null,null,null,null,null);
        //берем голову бинарной кучи
        Node<String> head=root;
        //покуда узел не пустой
