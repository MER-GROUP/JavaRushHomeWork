...
public class Solution extends AbstractList<String> implements List<String>,Cloneable,Serializable {
    ...
    public static void main(String[] args) throws CloneNotSupportedException, IOException, ClassNotFoundException {
        ...
        listTree.remove("2");
        System.out.println(listTree);
        System.out.println("listTree.root.item="+((Solution) listTree).root.item);
        ...
        List<String> list = ((Solution) listTree).clone();
        ...
        System.out.println("list.getLastNode().item = "+((Solution)list).getLastNode().item);
        System.out.println("listTree.getLastNode().item = "+((Solution)listTree).getLastNode().item);
        ...
        System.out.println("list.getLastNode().item = "+((Solution)list).getLastNode().item);
        System.out.println("list.getLastNode().parent.item = "+((Solution)list).getLastNode().parent.item);
        System.out.println("list.getLastNode().parent.right.item = "+((Solution)list).getLastNode().parent.right.item);
        System.out.println("list.getLastNode().parent.left.item = "+((Solution)list).getLastNode().parent.left.item);
        System.out.println("list.getLastNode().parent.parent.item = "+((Solution)list).getLastNode().parent.parent.item);
        System.out.println("list.getLastNode().parent..parent.item = "+((Solution)list).getLastNode().parent.parent.parent.item);
        ...
        System.out.println("2 Expected null, actual is " + ((Solution) list).getParent("2"));
