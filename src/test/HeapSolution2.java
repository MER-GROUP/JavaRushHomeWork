...
По образу и подобию создать HeapSolution2.
...
*/
public class HeapSolution2 extends AbstractList<String> implements Cloneable,Serializable {
    //serialVersionUID//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static void main(String[] args) throws CloneNotSupportedException, IOException, ClassNotFoundException {
        //если так задекларировать listTree то HeapSolution2 не будет наследовать Object и
        //метод clone работать не будет.
        //List<String> listTree = new HeapSolution2();
        //поэтому объявляем так , HeapSolution2 наследует Object

        HeapSolution2 listTree = new HeapSolution2();
        ...
        System.out.println("Check isEmpty (listTree.isEmpty()): " + listTree.isEmpty() + " Size: " + listTree.size());
        HeapSolution2 list2222 = new HeapSolution2();
        System.out.println("Check isEmpty (list2222.isEmpty()): " + list2222.isEmpty() + " Size: " + list2222.size());
        list2222.add("test");
        System.out.println("Check isEmpty (list2222.isEmpty()): " + list2222.isEmpty() + " Size: " + list2222.size());
        HeapSolution2 list1111 = new HeapSolution2();
        System.out.println("Check isEmpty (list1111.isEmpty()): " + list1111.isEmpty() + " Size: " + list1111.size());

        System.out.println("---------getParent()----------");
        System.out.println("\nExpected 3, actual is " + ((HeapSolution2) listTree).getParent("8"));
        //System.out.println("listTree.get(5)="+listTree.get(5));//check exception
        System.out.println("---------remove()-getParent()---------");
        listTree.remove("5");
        System.out.println("listTree.remove(\"5\") - listTree = "+listTree);
        System.out.println("Expected null, actual is " + ((HeapSolution2) listTree).getParent("11"));
        System.out.println("listTree.remove(\"2\")");
        listTree.remove("2");
        System.out.println(listTree);
        System.out.println("listTree.root.item="+((HeapSolution2) listTree).root.item);
        ...
        HeapSolution2 list = ((HeapSolution2) listTree).clone();
        ...
        System.out.println("list.getLastNode().item = "+((HeapSolution2)list).getLastNode().item);
        System.out.println("listTree.getLastNode().item = "+((HeapSolution2)listTree).getLastNode().item);
        ...
        System.out.println("list.getLastNode().item = "+((HeapSolution2)list).getLastNode().item);
        System.out.println("list.getLastNode().parent.item = "+((HeapSolution2)list).getLastNode().parent.item);
        System.out.println("list.getLastNode().parent.right.item = "+((HeapSolution2)list).getLastNode().parent.right.item);
        System.out.println("list.getLastNode().parent.left.item = "+((HeapSolution2)list).getLastNode().parent.left.item);
        System.out.println("list.getLastNode().parent.parent.item = "+((HeapSolution2)list).getLastNode().parent.parent.item);
        System.out.println("list.getLastNode().parent..parent.item = "+((HeapSolution2)list).getLastNode().parent.parent.parent.item);
        ...
        System.out.println("\n---------------------------------------");
        System.out.println("1 Expected null, actual is " + ((HeapSolution2) list).getParent("1"));
        System.out.println("2 Expected null, actual is " + ((HeapSolution2) list).getParent("2"));
        System.out.println("3 Expected 1, actual is " + ((HeapSolution2) list).getParent("3"));
        System.out.println("4 Expected 1, actual is " + ((HeapSolution2) list).getParent("4"));
        System.out.println("8 Expected 3, actual is " + ((HeapSolution2) list).getParent("8"));
        System.out.println("11 Expected null, actual is " + ((HeapSolution2) list).getParent("11"));
        System.out.println("15 Expected 7, actual is " + ((HeapSolution2) list).getParent("15"));
        System.out.println("16 Expected 7, actual is " + ((HeapSolution2) list).getParent("16"));
        System.out.println("10 Expected 4, actual is " + ((HeapSolution2) list).getParent("10"));
        System.out.println("17 Expected 8, actual is " + ((HeapSolution2) list).getParent("17"));
        System.out.println("19 Expected 10, actual is " + ((HeapSolution2) list).getParent("19"));
        System.out.println("21 Expected 10, actual is " + ((HeapSolution2) list).getParent("21"));
        System.out.println("22 Expected 15, actual is " + ((HeapSolution2) list).getParent("22"));
        System.out.println("--->> By task and add more item:");
        System.out.println("23 Expected 15, actual is " + ((HeapSolution2) list).getParent("23"));
        System.out.println("24 Expected 16, actual is " + ((HeapSolution2) list).getParent("24"));
        System.out.println("25 Expected 16, actual is " + ((HeapSolution2) list).getParent("25"));
        System.out.println("26 Expected 17, actual is " + ((HeapSolution2) list).getParent("26"));
        System.out.println("27 Expected 17, actual is " + ((HeapSolution2) list).getParent("27"));
        System.out.println("28 Expected 19, actual is " + ((HeapSolution2) list).getParent("28"));
        System.out.println("29 Expected 19, actual is " + ((HeapSolution2) list).getParent("29"));
        System.out.println("30 Expected 21, actual is " + ((HeapSolution2) list).getParent("30"));
        System.out.println("31 Expected 21, actual is " + ((HeapSolution2) list).getParent("31"));
        System.out.println("32 Expected 22, actual is " + ((HeapSolution2) list).getParent("32"));
        System.out.println("---------------------------------------");
        ...
        HeapSolution2 solConAll=new HeapSolution2();
        solConAll.add("1");
        solConAll.add("16");
        solConAll.add("32");
        ...
        HeapSolution2 sol = ((HeapSolution2) list).clone();
        ...
        System.out.println("\nTest addAll: ");
        HeapSolution2 add = new HeapSolution2();
        add.addAll(sol);
        ...
        HeapSolution2 s1=new HeapSolution2();
        s1.add("1");
        s1.add("2");
        s1.add("3");
        HeapSolution2 s2=new HeapSolution2();
        s2.add("1");
        s2.add("2");
        s2.add("3");
        ...
        HeapSolution2 s3=new HeapSolution2();
        s3.add("1");
        s3.add("2");
        s3.add("3");
        s3.add("4");
        ...
        s3.add("7");
        s3.add("8");
        HeapSolution2 s4=new HeapSolution2();
        s4.add("3");
        s4.add("6");
        s4.add("7");
        s4.add("8");
        ...
        HeapSolution2 sRet=new HeapSolution2();
        sRet.add("3");
        sRet.add("6");
        System.out.println("s4 = "+s4);
        s4.retainAll(sRet);
        ...
        HeapSolution2 list2 = (HeapSolution2) ois.readObject();
        ois.close();
        fis.close();
    ...
    public class IteratorHeapSolution2 implements Iterator{
        ...
        @Override
        public void remove() {
            HeapSolution2.this.remove(lastReturned.item);
        }//----------------------------------------------------------------------------------------------------
    }///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public Iterator<String> iterator() {
        return new IteratorHeapSolution2();
    }///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public String getParent(String value) {
        ...
        while (head!=null){
            if (value.equals(head.item)){
                //если если родитель это скрытый корень, то возвращаем null
                //if(head.parent==root) return null;
                //возвращаем родителя
...
//    private transient Node<String> root=new Node<String>("0");
    private transient Node<String> root=new Node<String>(null);
    ...
    //копирование дерева////////////////////////////////////////////////////////////////////////////////////////////////
    protected HeapSolution2 clone() throws CloneNotSupportedException {
        ...
        HeapSolution2 newTree = new HeapSolution2();
        //обнуляем состояние
        newTree.root.item=null;
        newTree.root.left=null;
        newTree.root.right=null;
        newTree.root.next=null;
    ...
    */
    ...
    //доступ по индексу запрещен, пользуемся исключением UnsupportedOperationException//////////////////////////////////
    @Override
    public HeapSolution2 subList(int fromIndex, int toIndex) {
        throw new UnsupportedOperationException();
    ...
    */
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof HeapSolution2))
            return false;

        Iterator<?> e1 = iterator();
        Iterator<?> e2 = ((HeapSolution2) o).iterator();
